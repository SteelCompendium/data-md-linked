...
The description of equipment in your kit is limited to broad categories, leaving you free to decide the specifics that best align with your vision of your character. For instance, the [Guisarmier](REL_PATH_PREFIXRules/Kits/GuisarmierREL_PATH_SUFFIX) kit provides medium armor and a polearm. One player using this kit could wear heavy layers of hide and wield a longspear, while another might wear a shining breastplate and carry a halberd into battle.
...
A kit that has a [disengage](REL_PATH_PREFIXRules/Abilities/Common/Move%20Actions/DisengageREL_PATH_SUFFIX) bonus increases the number of squares you can shift when you take the [Disengage](REL_PATH_PREFIXRules/Abilities/Common/Move%20Actions/DisengageREL_PATH_SUFFIX) move action (see [Chapter 10: Combat](#page-288-0)).

### Kit Signature Ability

Each kit grants a signature ability, **whose distance and damage already includes the kit's bonuses**. For instance, the [Guisarmier](REL_PATH_PREFIXRules/Kits/GuisarmierREL_PATH_SUFFIX) kit's Forward Thrust, Backward Smash ability has a distance of melee 2 and deals 4, 7, or 9 damage depending on the tier outcome, with that distance and damage including the bonuses from the kit.
...
The [Guisarmier](REL_PATH_PREFIXRules/Kits/GuisarmierREL_PATH_SUFFIX) kit is for those who want to use a polearm for extended reach while remaining protected by sturdy armor. This is the kit that allows you to become the ultimate halberd, longspear, or glaive fighter.
...
The [Mountain](REL_PATH_PREFIXRules/Kits/MountainREL_PATH_SUFFIX) kit does exactly what it says on the tin. You don heavy armor and raise a heavy weapon to stand strong against your foes, quickly demolishing them when it's your turn to strike.
...
If you want a good balance of protection, speed, and damage, the [Panther](REL_PATH_PREFIXRules/Kits/PantherREL_PATH_SUFFIX) kit is for you. This kit increases your Stamina not by wearing armor, but through the focused battle preparation of body and mind, letting you be fast and mobile while swinging a heavy weapon at your foes.
...
Meant for brawlers and boxers, the [Pugilist](REL_PATH_PREFIXRules/Kits/PugilistREL_PATH_SUFFIX) kit gives you access to a melee fighting style that grants a boost to Stamina and damage while allowing you to float like a butterfly. If you want to be a tough, strong hero who doles out punishment with your fists, then this kit is for you.
...
The [Raider](REL_PATH_PREFIXRules/Kits/RaiderREL_PATH_SUFFIX) kit keeps you protected while granting you full mobility, providing a boost to speed and distance that lets you run around the battlefield like a Viking warrior.
...
The [Ranger](REL_PATH_PREFIXRules/Kits/RangerREL_PATH_SUFFIX) kit outfits you with medium armor and weapons for every challenge, letting you easily switch between melee and ranged combat. This kit provides a good balance of bonuses to defense and offense to create a hero who is a jack-of-all-trades.
...
- **≤11:** 3 + M or A damage; A < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
- **12-16:** 5 + M or A damage; A < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
- **17+:** 7 + M or A damage; A < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
The [Sniper](REL_PATH_PREFIXRules/Kits/SniperREL_PATH_SUFFIX) kit gives you the tools and techniques to take down enemies from afar. This kit can help you become the archer who lurks behind trees or down tunnels, picking off enemies with a bow or crossbow as they approach.
...
The [Spellsword](REL_PATH_PREFIXRules/Kits/SpellswordREL_PATH_SUFFIX) kit combines melee strikes and a little bit of magic, letting you create a warrior who doesn't have to choose between the incantation and the blade.
...
If you want to be mobile and deal a lot of damage with melee strikes, then you should reach for the [Swashbuckler](REL_PATH_PREFIXRules/Kits/SwashbucklerREL_PATH_SUFFIX) kit. This is a great kit for heroes who want to be master duelists.
...
- **17+:** 9 + M or A damage; push 3; M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
