...
The gods are powerful, but forbidden from acting directly upon or within the world. To enact their will, they use intermediaries—beings of [demigod](REL_PATH_PREFIXRules/Titles/4th%20Echelon/DemigodREL_PATH_SUFFIX)-like status, once mortals, who now serve their patron god in eternity. Many [humans](REL_PATH_PREFIXRules/Ancestries/HumanREL_PATH_SUFFIX) call these beings saints, while the other speaking peoples use the term heroes, or legendary heroes, not to be confused with the heroes you make using the character creation rules in this book.
...
The ten thousand were not home, but they were home free. For this was territory held by their allies. The church of Khorvath Who Slew a Thousand spread quickly and now all [orcs](REL_PATH_PREFIXRules/Ancestries/OrcREL_PATH_SUFFIX) invoke her name whenever faced with a seemingly impossible task.
