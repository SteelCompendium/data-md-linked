...
In the real world, negotiations rarely come with a threat of immediate violence. Ambassadors don't usually get into fistfights. But this is a heroic fantasy RPG, featuring heroes who are armed to the teeth and able to alter reality with their minds. The threat of violence is already implied. Everyone involved knows that the characters could draw [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) at any moment.

The Director typically assumes that the underlying potential for events to turn violent is already factored into every negotiation. However, if the heroes decide to bring that threat to the forefront, then they've exited the realm of negotiation and have entered into a different type of relationship—and it's probably time to draw [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX).

Negotiation is about persuading someone to help you willingly because you've convinced them that meeting your objectives is a good idea. Working with you is wise or logical, or might make them [look](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) good. A hero can absolutely threaten someone with violence and force them to do what they want, but this is an incredibly temporary state. A threatened NPC isn't willingly doing what they've been asked. They're doing it on threat of violence, and will comply only while that threat is evident—after which, they'll likely go [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to their previous behavior as soon as they think they can get away with it.
...
If one or more heroes negotiating with an NPC can communicate in the NPC's native language (not including Caelian), then the NPC's patience increases by 1 at the start of the negotiation (to a maximum of 5). If three or more heroes negotiating with an NPC can communicate in the NPC's native language, the NPC's patience increases by 2 (to a maximum of 5). [Chapter 4: Background](REL_PATH_PREFIXRules/Chapters/BackgroundREL_PATH_SUFFIX) has information on some of the languages in the game.
...
- "If you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) us into the dragon's cave, we'll give you half the wyrm's hoard once we cut off the creature's head. That could benefit generations of students at your academy!"
...
- "I understand your grandchild is hell-bent on joining the service. I happen to have a magic suit of armor that could help them ward off the blows of monsters and ruffians. I'd be happy to give it to you, in exchange for borrowing your griffons for a few days. After all, I won't need the armor if I can simply [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) over the marsh's monsters."
...
Arguments that appeal to the revelry motivation contend that striking a deal with the heroes will allow the NPC to get [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to reveling sooner, longer, or harder. Example arguments include the following:
...
An NPC with the vengeance motivation wants to harm another who has hurt them. Their desire for revenge could be proportional to the harm that was inflicted upon them, or they might wish to pay [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) their pain with interest. In some cases, a desire for vengeance can be satisfied only by the death of another, but an NPC might wish to pay [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) their own suffering with embarrassment, career failure, or some other less permanent pain.
...
| Suspicious | [Doubts](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/DoubtREL_PATH_SUFFIX) the heroes' motives but is willing to listen.                                             | 2        | 2        |
...
| Friendly   | The heroes seem like the NPC's people. The NPC is willing to give them the benefit of the [doubt](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/DoubtREL_PATH_SUFFIX). | 3        | 4        |
...
After killing the true lord of Bedegar, the tyrannical Lord Saxton took over the barony's capital, and is presently gathering forces to march on the rest of Bedegar's settlements. The heroes recently saved Edmund, the true heir to Bedegar's throne, and are [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) attempting to build an army that can stand against Saxton and defeat the tyrant.
...
**Alyssa (playing Jorn, a [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX)):** *"We're building an army to take down Saxton once and for all."*

In this scenario, all the heroes have a Renown of 2 except for Jorn, who has a Renown of 3 and is therefore famous to Zola.

**Director:** *Zola gives a mirthless chuckle as she shakes her head. "Oh is that all? I have to tell you, I don't think the four of you stand much of a chance. Unless you're hiding a legion or two of [dwarves](REL_PATH_PREFIXRules/Ancestries/DwarfREL_PATH_SUFFIX) in your pockets. Yes, you have Jorn the Mighty with you, but you'll need more than one famous warrior to win the day."*

**Alyssa:** *Ah! So she has heard of me at least! Thanks, Renown.*

**Grace (playing Val, a [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX)):** *"We don't. But we do have Lord Edmund—the true heir to the Bedegar throne."*

**Director:** *Zola nods, impressed. "I'm glad the boy is safe, but that's all he is—a boy, not an army."*

**Matt (playing Linn, a [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX)):** *"He's a boy people will rally around. We have no army, but that's why we're here. We're planning on changing that. Can you spare any soldiers for our cause?"*
...
**Director:** *Zola leans [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) on her crate. "There it is. The Clock has sacrificed much against Saxton. Why should we risk more to help? No one was here to help us months ago when we stood up to tyranny."*
...
**Director:** *Zola sits [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX), chuckling. "There's two things I can't stand anyone telling me to kiss a ring and merry fools who would rather go drinking than fight for their freedom. Luckily, you're not the latter." You can tell that revelry also won't go over well with Zola.*

The heroes [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) know both of Zola's pitfalls: higher authority and revelry.
...
**Grace:** *We could push the Clock to do it themselves, but I can't see Val turning her [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) on people in need.*
