...
Your class provides you with many of your features, most of your abilities—your most potent combat moves and noncombat options and a Heroic Resource that fuels many of those abilities. This book presents nine [classes](REL_PATH_PREFIXRules/Chapters/ClassesREL_PATH_SUFFIX) to choose from.

**[Censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX):** A [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) is a trained warrior devoted to a saint or god. They hunt down the forces of evil using melee weapons and magic granted to them by their divine patron, specializing in confronting the wicked and locking down single enemies during combat.

**[Conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX):** A [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX) is the devoted priest of a saint or god. They wield divine magic that smites enemies with holy energy and supports their allies, and are renowned for their healing abilities.

**[Elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX):** An [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX) studies the elemental forces of the timescape and controls earth, fire, the void, and more with magic. Many of their abilities cover wide areas of the battlefield, and they have a versatile array of tricks that allow them to both control combat and manipulate the environment around them when the fight is done.
...
**[Tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX):** A brilliant strategist and weapons master, the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) excels at granting allies more movement and actions on the battlefield. They also support allies outside of combat, always inspiring their friends to greatness.
...
The name and story text for abilities sometimes refers to specific ways in which the ability plays out—particularly combat abilities whose names imply specific types of weapons or tactics. However, that narrative flavor has no effect on how an ability can be used. For example, the [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX)'s [Impaled](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/ImpaledREL_PATH_SUFFIX) ability allows you to [grab](REL_PATH_PREFIXRules/Abilities/Common/Maneuvers/GrabREL_PATH_SUFFIX) a target, setting up the idea of harpooning your monstrous foe with a sword to keep them close. But you can use that ability with an axe, a mace, a hammer, or any other weapon.
...
- The [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX)'s wrath
- The [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX)'s piety
- The [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX)'s essence
- The [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX)'s ferocity
- The [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX)'s discipline
- The [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX)'s insight
- The [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX)'s focus
- The [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX)'s clarity
- The [troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX)'s drama
...
Some abilities don't cost your Heroic Resource to use but allow you to spend your Heroic Resource to enhance or add effects to the ability, such as the [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX)'s [Healing Grace](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Healing%20GraceREL_PATH_SUFFIX). These abilities are not heroic abilities unless the baseline ability can't be used without spending your Heroic Resource.
...
If an ability requires a triggered action or a free triggered action to use, a "Trigger" entry is part of the ability. For example, the trigger for the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX)'s [Parry](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/ParryREL_PATH_SUFFIX) ability is: "A creature deals damage to the target." A [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) can use their [Parry](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/ParryREL_PATH_SUFFIX) ability only when that specific triggering event occurs.
...
When an ability can target creatures and objects, the ability can damage objects. However, unless otherwise noted (as with the [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX)'s [Minor Telekinesis](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/1st-Level%20Tradition%20Features/Minor%20TelekinesisREL_PATH_SUFFIX) ability) or if the Director allows it, objects are immune to an ability's other effects. If an ability forces an object to make a test, the object automatically gets a tier 1 result on the test.
...
Using the [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX)'s [Brutal Slam](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/Brutal%20SlamREL_PATH_SUFFIX) ability as an example again, that ability uses a Might power roll and features the following damage expressions in the three tier outcomes of the power roll:

- **≤11:** 3 + M damage
- **12-16:** 6 + M damage
- **17+:** 9 + M damage

For a [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX) with a Might of 2, the ability's damage breakdown would be:
...
Many abilities and other effects impose conditions and unique statuses on targets. But creatures sometimes get a chance to resist such effects. After all, a monster with a high Might should be harder to knock [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) most of the time than a creature lacking in that characteristic.
...
- **≤11:** 3 + I holy damage; A < WEAK, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
- **12-16:** 6 + I holy damage; A < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
- **17+:** 9 + I holy damage; A < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)

At 1st level, a [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX) uses their Intuition score to determine their potency values, and that score is 2. That gives the [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX) the following potencies:
...
- **≤11:** 5 holy damage; A < 0, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
...
Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities—for example, the [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX)'s [Judgment](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/JudgmentREL_PATH_SUFFIX) ability and the [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX)'s Null Field ability—allow you to manipulate the value of potencies. If you build a hero who can adjust potencies, pay attention during combat! You might be able to help out a friend who needs a little boost to make their ability take full effect, or hinder an enemy about to lock down one of your allies.
...
For example, the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX)'s [Overwatch](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/OverwatchREL_PATH_SUFFIX) ability allows the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) to spend 1 focus to impose the [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) targets a creature whose high Reason leaves them unaffected, the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) doesn't waste any [focus](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/FocusREL_PATH_SUFFIX). However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
A [troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX)'s battle song, a [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX)'s building [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX), and a [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
While a creature is [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX), whenever they use a main action, use a triggered action, or make a test or ability roll using Might or Agility, they lose Stamina equal to 1d6 + their level after the main action, triggered action, or power roll is resolved. This Stamina loss can't be prevented in any way, and only happens once per action.

You take damage from this condition when you use a main action off your turn. For example, a signature ability used as a free triggered action with the assistance of the [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX)'s [Strike Now](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Strike%20NowREL_PATH_SUFFIX) ability triggers the damage from the [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) condition.
...
When a creature is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX), any ability roll they make against the source of their fear takes a bane. If that source is a creature, their ability rolls made against the [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) creature gain an edge. A [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) creature can't willingly move closer to the source of their fear if they know the location of that source. If a creature gains the [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) condition from one source while already [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) by a different source, the new condition replaces the old one.
...
A creature who is [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) has a double bane on ability rolls for any ability that doesn't target the creature who [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) them, as long as they have line of effect to that creature. If a creature gains the [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) condition from one source while already [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) by a different source, the new condition replaces the old one.
...
For example a 6th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) has "Signature, 3, 5, 7, 9" in their Abilities column, and "5, 9" in their Order Abilities column (representing the [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX)'s subclass). This means a [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) of that level has a signature ability and four heroic abilities costing 3, 5, 7, and 9 wrath respectively, plus an additional two subclass heroic abilities costing 5 and 9 [wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX).
...
Demons and deathless fear you. Criminals run from the sight of your shadow. Agents of chaos, blasphemers, and heretics tremble at the sound of your voice. You carry the power of the gods, armed with [wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX) and sent out into the world first to seek, then [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) those whose actions—or even existence—are anathema to your church.

As a [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you're at your best against the strongest foes. Your [judgment](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/JudgmentREL_PATH_SUFFIX) terrifies heretics, stops enemies in their tracks, and even hurls them across the battlefield.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- | -------------------- |
| 1st   | [Censor Order](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/Censor%20OrderREL_PATH_SUFFIX), [Deity and Domains](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Deity%20and%20DomainsREL_PATH_SUFFIX), [Wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX), [Judgment](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/JudgmentREL_PATH_SUFFIX), [Kit](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/KitREL_PATH_SUFFIX), [My Life for Yours](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/My%20Life%20for%20YoursREL_PATH_SUFFIX), Domain Feature, [Censor Abilities](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/Censor%20AbilitiesREL_PATH_SUFFIX) | Signature, 3, 5           | -                    |
| 2nd   | Perk, Order Features, Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Signature, 3, 5           | 5                    |
| 3rd   | [Look On My Work and Despair](REL_PATH_PREFIXRules/Features/Censor/3rd-Level%20Features/Look%20On%20My%20Work%20and%20DespairREL_PATH_SUFFIX), 7-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7        | 5                    |
| 4th   | Characteristic Increase, Perk, Skill, [Wrath Beyond Wrath](REL_PATH_PREFIXRules/Features/Censor/4th-Level%20Features/Wrath%20Beyond%20WrathREL_PATH_SUFFIX), Domain Feature                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Signature, 3, 5, 7        | 5                    |
| 5th   | Order Feature, 9-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7, 9     | 5                    |
| 6th   | [Implement of Wrath](REL_PATH_PREFIXRules/Features/Censor/6th-Level%20Features/Implement%20of%20WrathREL_PATH_SUFFIX), Perk, Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Signature, 3, 5, 7, 9     | 5, 9                 |
| 7th   | Characteristic Increase, Domain Feature, [Focused Wrath](REL_PATH_PREFIXRules/Features/Censor/7th-Level%20Features/Focused%20WrathREL_PATH_SUFFIX), Skill                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Signature, 3, 5, 7, 9     | 5, 9                 |
| 8th   | Perk, Order Feature, 11-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9                 |
| 9th   | [Improved Implement of Wrath](REL_PATH_PREFIXRules/Features/Censor/9th-Level%20Features/Improved%20Implement%20of%20WrathREL_PATH_SUFFIX), Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7, 9, 11 | 5, 9, 11             |
| 10th  | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Censor/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), Perk, Skill, [Templar](REL_PATH_PREFIXRules/Features/Censor/10th-Level%20Features/TemplarREL_PATH_SUFFIX), [Virtue](REL_PATH_PREFIXRules/Features/Censor/10th-Level%20Features/VirtueREL_PATH_SUFFIX), [Wrath of the Gods](REL_PATH_PREFIXRules/Features/Censor/10th-Level%20Features/Wrath%20of%20the%20GodsREL_PATH_SUFFIX)                                                                                                                                                                                                                                                                                                      | Signature, 3, 5, 7, 9, 11 | 5, 9, 11             |

### 1st-Level Features

As a 1st-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.

#### Censor Order

[Censors](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) are the will of their god made physically manifest, and you act as your god's agent in the world. As you shoulder that responsibility, you choose a [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) order from the following options, each of which grants you a skill. (*Quick Build:* Paragon.)
...
Your [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) order is your subclass, and your choice of order determines many of the features you'll gain as you gain new levels.
...
You pick out the enemies most worthy of your [wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX) and place a divine judgment upon them, censoring them with the power of your god. You have the following ability.
...
> | **📏 Ranged 10**  | **🎯 One enemy** |
>
> **Effect:** The target is judged by you until the end of the encounter, you use this ability again, you willingly end this effect (no action required), or another [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX) judges the target.
>
...
>
> **Spend 1 Wrath:** You can end one effect on the target that is ended by a saving throw or that ends at the end of their turn, or a [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) target can stand up.
...
> **Power Roll + Might:**
>
> - **≤11:** 2 + M holy damage; P < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 + M holy damage; P < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 7 + M holy damage; P < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P holy damage; I < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 8 + P holy damage; I < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 11 + P holy damage; I < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 6 + M holy damage; [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **12-16:** 9 + M holy damage; [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **17+:** 13 + M holy damage; [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
>
> **Effect:** If the target makes a strike against a creature while [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) this way, you can spend 3 wrath to deal holy damage to them equal to your Presence score, then change the target of the strike to another target within the strike's distance.
...
As a 2nd-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 8 + M holy damage; P < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 12 + M holy damage; P < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 15 + M holy damage; P < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** If the target is already [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of you or another creature and this ability would frighten them again, they instead take psychic damage equal to twice your Presence score.
...
As a 3rd-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.

#### Look On My Work and Despair

Your judgment has grown in divine power, instilling fear in those you condemn. Whenever you use your [Judgment](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/JudgmentREL_PATH_SUFFIX) ability, you can spend 1 [wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX), and if the target has P < AVERAGE, they are [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of you (save ends). Additionally, whenever a creature judged by you is reduced to 0 Stamina and you use [Judgment](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/JudgmentREL_PATH_SUFFIX) as a free triggered action, if the new target has P < STRONG, they are [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of you (save ends). If the target is already [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of you, they instead take holy damage equal to twice your Presence score.
...
As a 4th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
As a 5th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Ranged 10** | **🎯 Self or one ally** |
>
> **Effect:** The target ends any condition or effect on them that is ended by a saving throw or that ends at the end of their turn, or a [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) target can stand up. The target then gains 2 surges, can shift up to their speed while ignoring difficult terrain, and can use a strike signature ability as a free triggered action.
...
As a 6th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
- Any creature struck by the weapon who has holy weakness and has P < STRONG is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) and [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends).
...
- The weapon's wielder can't be made [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX).
...
> **Power Roll + Presence:**
>
> - **≤11:** Slide 3; I < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** Slide 5; I < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** Slide 7; I < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
...
When you gain [wrath](REL_PATH_PREFIXRules/Features/Censor/1st-Level%20Features/WrathREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 3 wrath instead of 2.
...
As an 8th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; I < WEAK, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 13 + M damage; I < AVERAGE, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 18 + M damage; I < STRONG, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** At the end of each of your turns, a target [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) this way deals holy damage equal to twice your Presence score to each enemy within 2 squares of them. Additionally, a target [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) this way can't be targeted by their allies' abilities.
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P damage; I < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
As a 10th-level [censor](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), you gain the following features.
...
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ---------------- |
| 1st   | [Deity and Domains](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Deity%20and%20DomainsREL_PATH_SUFFIX), [Piety](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/PietyREL_PATH_SUFFIX), Domain Feature, [Healing Grace](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Healing%20GraceREL_PATH_SUFFIX), [Ray of Wrath](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Ray%20of%20WrathREL_PATH_SUFFIX), Triggered Action, [Prayer](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/PrayerREL_PATH_SUFFIX), [Conduit Ward](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Conduit%20WardREL_PATH_SUFFIX), [Conduit Abilities](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Conduit%20AbilitiesREL_PATH_SUFFIX) | Two signature, 3, 5           | -                |
| 2nd   | [The Lists of Heaven](REL_PATH_PREFIXRules/Features/Conduit/2nd-Level%20Features/The%20Lists%20of%20HeavenREL_PATH_SUFFIX), Perk, Domain Feature, Domain Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Two signature, 3, 5           | 5                |
| 3rd   | [Minor Miracle](REL_PATH_PREFIXRules/Features/Conduit/3rd-Level%20Features/Minor%20MiracleREL_PATH_SUFFIX), 7-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Two signature, 3, 5, 7        | 5                |
| 4th   | [Blessed Domains](REL_PATH_PREFIXRules/Features/Conduit/4th-Level%20Features/Blessed%20DomainREL_PATH_SUFFIX), [Characteristic Increase](REL_PATH_PREFIXRules/Features/Conduit/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), Domain Feature, Perk, Skill Increase                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Two signature, 3, 5, 7        | 5                |
| 5th   | Domain Feature, 9-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Two signature, 3, 5, 7, 9     | 5                |
| 6th   | [Burgeoning Saint](REL_PATH_PREFIXRules/Features/Conduit/6th-Level%20Features/Burgeoning%20SaintREL_PATH_SUFFIX), Perk, Domain Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Two signature, 3, 5, 7, 9     | 5, 9             |
| 7th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Conduit/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), Domain Feature, [Faithful's Reward](REL_PATH_PREFIXRules/Features/Conduit/7th-Level%20Features/Faithfuls%20RewardREL_PATH_SUFFIX), Skill Increase                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Two signature, 3, 5, 7, 9     | 5, 9             |
| 8th   | Domain Feature, Perk, 11-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Two signature, 3, 5, 7, 9, 11 | 5, 9             |
| 9th   | Domain Ability, [Faith's Sword](REL_PATH_PREFIXRules/Features/Conduit/9th-Level%20Features/Faiths%20SwordREL_PATH_SUFFIX), [Ordained](REL_PATH_PREFIXRules/Features/Conduit/9th-Level%20Features/OrdainedREL_PATH_SUFFIX)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
| 10th  | [Avatar](REL_PATH_PREFIXRules/Features/Conduit/10th-Level%20Features/AvatarREL_PATH_SUFFIX), [Characteristic Increase](REL_PATH_PREFIXRules/Features/Conduit/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Divine Power](REL_PATH_PREFIXRules/Features/Conduit/10th-Level%20Features/Divine%20PowerREL_PATH_SUFFIX), [Most Pious](REL_PATH_PREFIXRules/Features/Conduit/10th-Level%20Features/Most%20PiousREL_PATH_SUFFIX), Perk, Skill Increase                                                                                                                                                                                                                                                                                                                               | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11         |

### 1st-Level Features

As a [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
Choose one of the following triggered actions. (*Quick Build:* [Word of Guidance](REL_PATH_PREFIXRules/Abilities/Conduit/1st-Level%20Features/Word%20of%20GuidanceREL_PATH_SUFFIX).)
...
> - **17+:** 5 holy damage
>
> **Effect:** You can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) yourself and each ally in the area to unoccupied spaces in the area.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 6 + I holy damage; I < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 9 + I holy damage; I < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 13 + I holy damage; I < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
...
>
> **Effect:** Each target can spend a Recovery. Additionally, each target can use a free triggered action to end one effect on them that is ended by a saving throw or that ends at the end of their turn, or to stand up if [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX).

### 2nd-Level Features

As a 2nd-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 2 damage; A < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 3 damage; A < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 7 damage; A < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
...
As a 4th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
As a 6th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 4 burst**  | **🎯 Self and each ally in the area** |
>
> **Effect:** Each target can spend any number of Recoveries. Additionally, each target can end one effect on themself that is ended by a saving throw or that ends at the end of their turn, or they can stand up if [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX).
...
> **Power Roll + Intuition:**
>
> - **≤11:** 5 damage; M < WEAK, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)
> - **12-16:** 8 damage; M < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)
> - **17+:** 11 damage; M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)
...
As a 7th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
When you roll for piety at the start of your turn in combat, you gain 1d3 + 1 [piety](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/PietyREL_PATH_SUFFIX).
...
As an 8th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Ranged 10**  | **🎯 Self or one ally** |
>
> **Effect:** The target can spend any number of Recoveries, can end any effects on them that are ended by a saving throw or that end at the end of their turn, and can stand up if they are [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX). Additionally, at the start of each of their turns until the end of the encounter or until they are dying, the target gains 3 surges.
...
As a 9th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Ranged 10**  | **🎯 Four allies** |
>
> **Effect:** You can target yourself instead of one ally with this ability. Each target can spend any number of Recoveries, can end any effects on them that are ended by a saving throw or that end at the end of their turn, and can stand up if they are [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX).
...
> **Power Roll + Intuition:**
>
> - **≤11:** 10 + I damage; A < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 15 + I damage; A < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 21 + I damage; A < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** While [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) this way, the target takes 10 damage at the start of each of your turns.
...
As a 10th-level [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), you gain the following features.
...
As a 1st-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
>
> **Effect:** You can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up to a number of squares equal to your Reason score.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R corruption damage; R < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 4 + R corruption damage; R < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 6 + R corruption damage; R < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
> - **≤11:** 3 damage
> - **12-16:** 5 damage
> - **17+:** 8 damage; M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
>
...
As a 3rd-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
As a 6th-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Ranged 10**                     | **🎯 Self or one ally** |
>
> **Effect:** The target has a +3 bonus to speed, they can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX), and their abilities ignore concealment. Additionally, whenever the target gains their Heroic Resource, they gain 1 additional Heroic Resource. This effect lasts until the start of your next turn.
>
> **Persistent 1:** The effect lasts until the start of your next turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** You [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the target up to 4 squares.
> - **12-16:** You [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the target up to 6 squares.
> - **17+:** You [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the target up to 8 squares.
>
> **Effect:** If the target is [teleported](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) to a space where they would fall, they immediately do so, treating the fall as if their Agility score were 0. The target takes fire damage from the fall, and each enemy within 3 squares of where they land takes the same amount of fire damage. The ground within 3 squares of where the target lands is difficult terrain.
...
As a 7th-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
When you gain [essence](REL_PATH_PREFIXRules/Features/Elementalist/1st-Level%20Features/EssenceREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 3 essence instead of 2.
...
As an 8th-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
> > **Earth Harness**
> >
> > A creature that has the [Earth Accepts Me](REL_PATH_PREFIXRules/Features/Elementalist/3rd-Level%20Features/3rd-Level%20Specialization%20Feature/Earth%20Accepts%20MeREL_PATH_SUFFIX) ability can use it as a free action to meld into the source.
>
> > **Boulder Bash**
> >
...
> **Power Roll + Reason:**
>
> - **≤11:** M < WEAK, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
> - **12-16:** M < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
> - **17+:** M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
>
> **Effect:** You create a fissure in the ground adjacent to you that is a 10 x 2 line and 6 squares deep. Each creature in the area who is [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and size 2 or smaller falls in. Other creatures can enter the fissure or can shift to the nearest unoccupied space of their choice outside it.

### 9th-Level Features

As a 9th-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 13 + R fire damage; I < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 18 + R fire damage; I < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 25 + R fire damage; I < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** This damage ignores immunity.

### 10th-Level Features

As a 10th-level [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), you gain the following features.
...
When you gain [essence](REL_PATH_PREFIXRules/Features/Elementalist/1st-Level%20Features/EssenceREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 4 essence instead of 3.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- | ---------------- |
| 1st   | [Primordial Aspect](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Primordial%20AspectREL_PATH_SUFFIX), [Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX), [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX), Aspect Features, [Aspect Triggered Action](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Aspect%20Triggered%20ActionREL_PATH_SUFFIX), [Mighty Leaps](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Mighty%20LeapsREL_PATH_SUFFIX), [Fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX) Abilities | Signature, 3, 5           | -                |
| 2nd   | Perk, Aspect Feature, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Signature, 3, 5           | 5                |
| 3rd   | Aspect Feature, 7-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7        | 5                |
| 4th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Fury/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Damaging Ferocity](REL_PATH_PREFIXRules/Features/Fury/4th-Level%20Features/Damaging%20FerocityREL_PATH_SUFFIX), [Growing Ferocity Improvement](REL_PATH_PREFIXRules/Features/Fury/7th-Level%20Features/Growing%20Ferocity%20ImprovementREL_PATH_SUFFIX), Perk, [Primordial Attunement](REL_PATH_PREFIXRules/Features/Fury/4th-Level%20Features/Primordial%20AttunementREL_PATH_SUFFIX), [Primordial Strike](REL_PATH_PREFIXRules/Features/Fury/4th-Level%20Features/Primordial%20StrikeREL_PATH_SUFFIX), Skill           | Signature, 3, 5, 7        | 5                |
| 5th   | Aspect Feature, 9-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7, 9     | 5                |
| 6th   | [Marauder of the Primordial Chaos](REL_PATH_PREFIXRules/Features/Fury/6th-Level%20Features/Marauder%20of%20the%20Primordial%20ChaosREL_PATH_SUFFIX), Perk, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9     | 5, 9             |
| 7th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Fury/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Elemental Form](REL_PATH_PREFIXRules/Features/Fury/7th-Level%20Features/Elemental%20FormREL_PATH_SUFFIX), [Greater Ferocity](REL_PATH_PREFIXRules/Features/Fury/7th-Level%20Features/Greater%20FerocityREL_PATH_SUFFIX), [Growing Ferocity Improvement](REL_PATH_PREFIXRules/Features/Fury/7th-Level%20Features/Growing%20Ferocity%20ImprovementREL_PATH_SUFFIX), Skill                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5, 9             |
| 8th   | Perk, Aspect Feature, 11-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9             |
| 9th   | [Harbinger of the Primordial Chaos](REL_PATH_PREFIXRules/Features/Fury/9th-Level%20Features/Harbinger%20of%20the%20Primordial%20ChaosREL_PATH_SUFFIX), Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
| 10th  | [Chaos Incarnate](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Chaos%20IncarnateREL_PATH_SUFFIX), [Characteristic Increase](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Growing Ferocity Improvement](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Growing%20Ferocity%20ImprovementREL_PATH_SUFFIX), Perk, [Primordial Ferocity](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Primordial%20FerocityREL_PATH_SUFFIX), [Primordial Power](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Primordial%20PowerREL_PATH_SUFFIX), Skill                | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |

### 1st-Level Features

As a 1st-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
You can't obtain lower than a tier 2 outcome on any Might test made to [jump](REL_PATH_PREFIXRules/Movement/JumpREL_PATH_SUFFIX) (see Movement Types in Chapter 10: Combat).
...
> **Power Roll + Might:**
>
> - **≤11:** 2 + M damage; M < WEAK, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **12-16:** 5 + M damage; M < AVERAGE, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **17+:** 7 + M damage; M < STRONG, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; M < WEAK, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 + M damage; M < AVERAGE, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
> - **17+:** 8 + M damage; M < STRONG, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
>
> **Effect:** While [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) this way, the target takes damage equal to your Might score at the end of each of your turns.
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; M < WEAK, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) and [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 + M damage; M < AVERAGE, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) and [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 + M damage; M < STRONG, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) and [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
>
...
As a 2nd-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; P < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 + M damage; P < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 8 + M damage; P < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 2 damage; A < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 4 damage; A < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 6 damage; A < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 4 damage; I < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 damage; I < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 damage; I < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
>
...
> **Power Roll + Might:**
>
> - **≤11:** 2 damage; push 1; M < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 damage; push 2; M < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 7 damage; push 3; M < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
>
...
As a 4th-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
Your [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) feature provides additional benefits when you have 8 or more [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX).
...
As a 6th-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** You [jump](REL_PATH_PREFIXRules/Movement/JumpREL_PATH_SUFFIX) up to your maximum [jump](REL_PATH_PREFIXRules/Movement/JumpREL_PATH_SUFFIX) distance and make one power roll that targets each creature adjacent to the space where you land.
>
> **Power Roll + Might:**
>
> - **≤11:** 4 damage; push 1
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; P < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 + M damage; P < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 + M damage; P < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** If a target who is not a leader or solo creature is winded by this strike, they are reduced to 0 Stamina and you choose an enemy within 5 squares of you. If that enemy has P < AVERAGE, they are [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of you (save ends).
...
> **Power Roll + Might:**
>
> - **≤11:** 8 damage; M < WEAK, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **12-16:** 13 damage; M < AVERAGE, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **17+:** 17 damage; M < STRONG, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
>
> **Effect:** You can shift up to 4 squares, bringing the target with you. While [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) this way, the target takes damage equal to twice your Might score at the start of each of your turns.
...
>
> **Effect:** Until the end of the encounter or until you are dying, each enemy target takes damage of your primordial damage type equal to twice your Might score at the end of each of your turns. Additionally, you can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) while the aura is active. Each ally target who starts or ends their turn in the area can also [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) until the start of their next turn or until the effect ends.
>
...
As a 7th-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
When you gain [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 1d3 + 1 ferocity instead of 1d3.

#### Growing Ferocity Improvement

Your [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) feature provides additional benefits when you have 10 or more [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX).
...
You can create a temporary source of elemental power as a respite activity. This source of elemental power lasts 24 hours after creation, and can be used to create a portal to Quintessence with your [Primordial Portal](REL_PATH_PREFIXRules/Features/Fury/6th-Level%20Features/Primordial%20PortalREL_PATH_SUFFIX) feature. If you do so, the source of elemental power lasts as long as the portal is maintained in your network.
...
As a 10th-level [fury](REL_PATH_PREFIXRules/Classes/FuryREL_PATH_SUFFIX), you gain the following features.
...
The stormwight [primordial aspect](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Primordial%20AspectREL_PATH_SUFFIX) lets you channel your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) into the form of an animal and grants you knowledge of one stormwight kit of your choice. You can master additional stormwight kits through play, changing them out during a respite as with any other kit (see Chapter 6: Kits).
...
You wear no armor and wield only your unarmed strikes—which become devastating natural weapons as your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) grows.
...
Whenever you use forced movement to push a creature, you can pull that creature instead. Whenever you pull a creature adjacent to you and that creature has M < AVERAGE, you can use a free triggered action to make that creature [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) by you.
...
- **≤11:** 2 + M damage; M < WEAK, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
- **12-16:** 5 + M damage; M < AVERAGE, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
- **17+:** 11 + M damage; M < STRONG, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)

##### Growing Ferocity

As your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) grows, you gain benefits as noted on the Boren [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.
...
With this stormwight kit, you channel your [primordial ferocity](REL_PATH_PREFIXRules/Features/Fury/10th-Level%20Features/Primordial%20FerocityREL_PATH_SUFFIX) into the form of a crow, becoming stealthy and quick. Corven are tied to the mountain passes and the hot winds that flow through them. This aspect is associated with the warm and fast-rising anabatic wind.
...
While you are in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX).
...
As your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) grows, you gain benefits as noted on the Corven [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.
...
As your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) grows, you gain benefits as noted on the Raden [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.
...
- **≤11:** 4 + M damage; A < WEAK, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
- **12-16:** 7 + M damage; A < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
- **17+:** 9 + M damage; A < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)

##### Growing Ferocity

As your [ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/FerocityREL_PATH_SUFFIX) grows, you gain benefits as noted on the Vuken [Growing Ferocity](REL_PATH_PREFIXRules/Features/Fury/1st-Level%20Features/Growing%20FerocityREL_PATH_SUFFIX) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.
...
As a 1st-level [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; A < WEAK, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **12-16:** 7 + A damage; A < AVERAGE, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
> - **17+:** 9 + A damage; A < STRONG, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (EoT)
> - **12-16:** 5 + A damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (EoT), slide 1
> - **17+:** 6 + A damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (EoT), slide 2
...
>
> **Effect:** Before the push is resolved, you [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the target to a square adjacent to you and opposite the one they started in. If the target can't be [teleported](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) this way, you can't push them.
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; A < WEAK, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 7 + A damage; A < AVERAGE, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 9 + A damage; A < STRONG, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; I < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 + A damage; I < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 7 + A damage; I < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + **A** psychic damage; M < WEAK, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 12 + **A** psychic damage; M < AVERAGE, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 16 + **A** psychic damage; M < STRONG, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** While [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) this way, the target takes damage equal to your Intuition score whenever they use a supernatural ability that costs Malice.
...
As a 2nd-level [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 cold damage; A < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 9 cold damage; A < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 13 cold damage; A < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
>
> **Effect:** While you have temporary Stamina from this ability, you can't be made [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) even while dying.

### 3rd-Level Features

As a 3rd-level [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), you gain the following features.

#### Psionic Leap

You can long [jump](REL_PATH_PREFIXRules/Movement/JumpREL_PATH_SUFFIX) and high [jump](REL_PATH_PREFIXRules/Movement/JumpREL_PATH_SUFFIX) a distance equal to twice your Agility score without needing to make a test.
...
As a 4th-level [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), you gain the following features.
...
Your [Discipline Mastery](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/Discipline%20MasteryREL_PATH_SUFFIX) feature provides additional benefits when you have 8 or more [discipline](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/DisciplineREL_PATH_SUFFIX).
...
As a 5th-level [null](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; I < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 10 + A damage; I < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 13 + A damage; I < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
>
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; A < WEAK, [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX)
...
Whenever you use your [Inertial Shield](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/Inertial%20ShieldREL_PATH_SUFFIX) triggered action, you gain immunity to acid, cold, corruption, fire, lightning, poison, and sonic damage equal to your Intuition score against the triggering damage.
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 damage; M < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX)
> - **12-16:** 8 damage; M < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX)
> - **17+:** 12 damage; M < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX)
...
> | **📏 10 wall within 10**  |  **🎯 Special** |
>
> **Effect:** You can place this wall in occupied squares, sliding each creature in the area into the nearest unoccupied space of your choice. The wall remains until the end of the encounter or until you are dying. The wall's squares are treated as stone squares for the purpose of damage, and you and allies can move freely through the wall. Each enemy who enters a square adjacent to the wall and has M < AVERAGE is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends). Each enemy who is force moved into the wall and has M < AVERAGE is [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends).
...
Your Stamina increases by 21 and you can't be made [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) even while dying. You no longer age or have need of food. Additionally, you can use Intuition instead of another characteristic when resisting potencies.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 8 + I cold damage; M < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 11 + I cold damage; M < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 15 + I cold damage; M < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** While [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) this way, the target takes cold damage equal to your Intuition score at the start of each of your turns. Additionally, whenever the target damages another creature while [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) this way, any potency associated with the damage is reduced by 2.
...
Your [Discipline Mastery](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/Discipline%20MasteryREL_PATH_SUFFIX) feature provides additional benefits when you have 12 or more [discipline](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/DisciplineREL_PATH_SUFFIX).

#### Manifold Body

When you gain [discipline](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/DisciplineREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 4 discipline instead of 3.
...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ----------------- |
| 1st   | [Shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX) College, [Insight](REL_PATH_PREFIXRules/Features/Shadow/1st-Level%20Features/InsightREL_PATH_SUFFIX), College Features, [College Triggered Action](REL_PATH_PREFIXRules/Features/Shadow/1st-Level%20Features/College%20Triggered%20ActionREL_PATH_SUFFIX), [Hesitation Is Weakness](REL_PATH_PREFIXRules/Features/Shadow/1st-Level%20Features/Hesitation%20Is%20WeaknessREL_PATH_SUFFIX), Kit, [Shadow Abilities](REL_PATH_PREFIXRules/Features/Shadow/1st-Level%20Features/Shadow%20AbilitiesREL_PATH_SUFFIX)                                                         | Signature, 3, 5           | -                 |
| 2nd   | College Feature, Perk, College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5           | 5                 |
| 3rd   | [Careful Observation](REL_PATH_PREFIXRules/Features/Shadow/3rd-Level%20Features/Careful%20ObservationREL_PATH_SUFFIX), 7-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Signature, 3, 5, 7        | 5                 |
| 4th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Shadow/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Keep It Down](REL_PATH_PREFIXRules/Features/Shadow/4th-Level%20Features/Keep%20It%20DownREL_PATH_SUFFIX), [Night Watch](REL_PATH_PREFIXRules/Features/Shadow/4th-Level%20Features/Night%20WatchREL_PATH_SUFFIX), Perk, Skill, [Surge of Insight](REL_PATH_PREFIXRules/Features/Shadow/4th-Level%20Features/Surge%20of%20InsightREL_PATH_SUFFIX)                                                                                                                                                     | Signature, 3, 5, 7        | 5                 |
| 5th   | College Feature, 9-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5                 |
| 6th   | Perk, [Umbral Form](REL_PATH_PREFIXRules/Features/Shadow/6th-Level%20Features/Umbral%20FormREL_PATH_SUFFIX), College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Signature, 3, 5, 7, 9     | 5, 9              |
| 7th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Shadow/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Keen Insight](REL_PATH_PREFIXRules/Features/Shadow/7th-Level%20Features/Keen%20InsightREL_PATH_SUFFIX), Skill, [Careful Observation Improvement](REL_PATH_PREFIXRules/Features/Shadow/7th-Level%20Features/Careful%20Observation%20ImprovementREL_PATH_SUFFIX), [Ventriloquist](REL_PATH_PREFIXRules/Features/Shadow/7th-Level%20Features/VentriloquistREL_PATH_SUFFIX)                                                                                                                             | Signature, 3, 5, 7, 9     | 5, 9              |
| 8th   | College Feature, Perk, 11-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7, 9, 11 | 5, 9              |
| 9th   | [Gloom Squad](REL_PATH_PREFIXRules/Features/Shadow/9th-Level%20Features/Gloom%20SquadREL_PATH_SUFFIX), College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |
| 10th  | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Shadow/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Death Pool](REL_PATH_PREFIXRules/Features/Shadow/10th-Level%20Features/Death%20PoolREL_PATH_SUFFIX), Perk, Skill, [Careful Observation Improvement](REL_PATH_PREFIXRules/Features/Shadow/10th-Level%20Features/Careful%20Observation%20ImprovementREL_PATH_SUFFIX), [Improved Umbral Form](REL_PATH_PREFIXRules/Features/Shadow/10th-Level%20Features/Improved%20Umbral%20FormREL_PATH_SUFFIX), [Subterfuge](REL_PATH_PREFIXRules/Features/Shadow/10th-Level%20Features/SubterfugeREL_PATH_SUFFIX) | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |

### 1st-Level Features

As a 1st-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
> - **≤11:** 3 + A damage
> - **12-16:** 5 + A damage
> - **17+:** 8 + A damage; I < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
>
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; A < WEAK, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 + A damage; A < AVERAGE, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 + A damage; A < STRONG, [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
...
As a 2nd-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
Your [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX) college grants your choice of one of two heroic abilities.
...
> - **17+:** 7 poison damage
>
> **Effect:** The gas remains in the area until the end of the encounter. Any creature who starts their turn in the area and has M < AVERAGE is [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends).
...
As a 3rd-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
> - **17+:** 18 + A damage
>
> **Effect:** The target is [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) by a willing ally within 5 squares of you until the end of the target's next turn.
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + A damage; A < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 12 + A damage; A < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 16 + A damage; A < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; M < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 11 + A damage; M < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)
> - **17+:** 16 + A damage; M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)

### 4th-Level Features

As a 4th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
As a 5th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; P < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 15 + A damage; P < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 21 + A damage; P < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** The target can't communicate with anyone until the end of the encounter.

### 6th-Level Features

As a 6th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
As a 7th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
You can target two creatures simultaneously with your [Careful Observation](REL_PATH_PREFIXRules/Features/Shadow/3rd-Level%20Features/Careful%20ObservationREL_PATH_SUFFIX) ability, observing both simultaneously. Making a strike against one target doesn't end your observation of the other target.
...
As an 8th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 11 corruption damage; A < WEAK, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 16 corruption damage; A < AVERAGE, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
> - **17+:** 21 corruption damage; A < STRONG, [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 12 damage; M < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 18 damage; M < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 24 damage; M < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)

### 9th-Level Features

As a 9th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
>
> **Effect:** On a critical hit, the target is [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) by the demon and pulled through the portal before it closes, never to be seen again.
...
As a 10th-level [shadow](REL_PATH_PREFIXRules/Classes/ShadowREL_PATH_SUFFIX), you gain the following features.
...
**As a [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you have abilities that heal your allies and grant them increased damage, movement, and attacks, even as you leave your enemies struggling to respond.**
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | ------------------ |
| 1st   | [Tactical Doctrine](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Tactical%20DoctrineREL_PATH_SUFFIX), [Focus](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/FocusREL_PATH_SUFFIX), Doctrine Feature, [Doctrine Triggered Action](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Doctrine%20Triggered%20ActionREL_PATH_SUFFIX), [Field Arsenal](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Field%20ArsenalREL_PATH_SUFFIX), [Mark](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/MarkREL_PATH_SUFFIX), [Strike Now](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Strike%20NowREL_PATH_SUFFIX), [Tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) Abilities | 3, 5           | -                  |
| 2nd   | Perk, Doctrine Feature, Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 3, 5           | 5                  |
| 3rd   | [Out of Position](REL_PATH_PREFIXRules/Features/Tactician/3rd-Level%20Features/Out%20of%20PositionREL_PATH_SUFFIX), 7-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 3, 5, 7        | 5                  |
| 4th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Tactician/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), Focus on Their Weakness, [Improved Field Arsenal](REL_PATH_PREFIXRules/Features/Tactician/4th-Level%20Features/Improved%20Field%20ArsenalREL_PATH_SUFFIX), Perk, Skill                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 3, 5, 7        | 5                  |
| 5th   | Doctrine Feature, 9-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 3, 5, 7, 9     | 5                  |
| 6th   | [Master of Arms](REL_PATH_PREFIXRules/Features/Tactician/6th-Level%20Features/Master%20of%20ArmsREL_PATH_SUFFIX), Perk, Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 3, 5, 7, 9     | 5, 9               |
| 7th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Tactician/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Heightened Focus](REL_PATH_PREFIXRules/Features/Tactician/7th-Level%20Features/Heightened%20FocusREL_PATH_SUFFIX), [Seize the Initiative](REL_PATH_PREFIXRules/Features/Tactician/7th-Level%20Features/Seize%20the%20InitiativeREL_PATH_SUFFIX), Skill, Doctrine Feature                                                                                                                                                                                                                                                                                                                                                              | 3, 5, 7, 9     | 5, 9               |
| 8th   | Perk, Doctrine Feature, 11-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 3, 5, 7, 9, 11 | 5, 9               |
| 9th   | [Grandmaster of Arms](REL_PATH_PREFIXRules/Features/Tactician/9th-Level%20Features/Grandmaster%20of%20ArmsREL_PATH_SUFFIX), Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 3, 5, 7, 9, 11 | 5, 9, 11           |
| 10th  | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Tactician/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Command](REL_PATH_PREFIXRules/Features/Tactician/10th-Level%20Features/CommandREL_PATH_SUFFIX), Perk, Skill, [True Focus](REL_PATH_PREFIXRules/Features/Tactician/10th-Level%20Features/True%20FocusREL_PATH_SUFFIX), [Warmaster](REL_PATH_PREFIXRules/Features/Tactician/10th-Level%20Features/WarmasterREL_PATH_SUFFIX)                                                                                                                                                                                                                                                                                                            | 3, 5, 7, 9, 11 | 5, 9, 11           |
...
Warfare is as old as civilization—and perhaps even older. As battle became ever more complex, military leaders invented [tactical doctrine](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Tactical%20DoctrineREL_PATH_SUFFIX), outlining how combatants should be structured, used, and deployed. Doctrine can be learned at war colleges passing on ancient martial traditions, or directly through blood and sweat on the battlefield. Whatever path brought you to your mastery of historically proven tactics, you choose a [tactical doctrine](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Tactical%20DoctrineREL_PATH_SUFFIX) from the following options, each of which grants you a skill. (*Quick Build:* Vanguard and the Intimidate skill.)
...
Your [tactical doctrine](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Tactical%20DoctrineREL_PATH_SUFFIX) is your subclass, and your choice of doctrine determines many of the features you'll gain as you gain new levels.
...
As a 2nd-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R damage; R < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 3 + R damage; R < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 4 + R damage; R < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
...
As a 3rd-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.

#### Out of Position

Even before battle begins, your enemies struggle to keep up with your tactics. At the start of an encounter, you can use a free triggered action to use your [Mark](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/MarkREL_PATH_SUFFIX) ability against one enemy you have line of effect to, even if you are surprised. You can then slide the marked target up to 3 squares, ignoring [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX). The target can't be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, whenever you or any ally deals damage to a target marked by you who has R < AVERAGE, the target is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) of the creature who dealt the damage (save ends).
...
As a 4th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
As a 5th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
As a 6th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
As a 7th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
As an 8th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
As a 9th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** R < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** R < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** R < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
...
As a 10th-level [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you gain the following features.
...
When you gain [focus](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/FocusREL_PATH_SUFFIX) at the start of each of your turns during combat, you gain 4 focus instead of 3.
...
Arare few people are born with the potential to harness psionic power, but only those who experience an awakening, a significant event that activates a [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX)'s abilities, can tap into the mind's full potential. You are one of those people—a master of psionics and a source of incredible power created through sheer force of will. You can move and change matter, time, gravity, the laws of physics, or another creature's mind.

**As a [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you are limited only by the strength of your mind. But the ability to wield multiple powers at once and change reality at will involves a gamble. Every manifestation has a chance of harming you, and [talents](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) who use too much power too quickly pay a deadly price.**
...
| Level | Features                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Abilities                     | Tradition Abilities |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) Tradition, [Clarity and Strain](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Clarity%20and%20StrainREL_PATH_SUFFIX), [Mind Spike](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Mind%20SpikeREL_PATH_SUFFIX), [Psionic Augmentation](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Psionic%20AugmentationREL_PATH_SUFFIX), [Talent Ward](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Talent%20WardREL_PATH_SUFFIX), [Telepathic Speech](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Telepathic%20SpeechREL_PATH_SUFFIX), Tradition Features, [Talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Two signature, 3, 5           | 5                   |
| 3rd   | [Scan](REL_PATH_PREFIXRules/Features/Talent/3rd-Level%20Features/ScanREL_PATH_SUFFIX), 7-Clarity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Two signature, 3, 5, 7        | 5                   |
| 4th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Talent/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Mind Projection](REL_PATH_PREFIXRules/Features/Talent/4th-Level%20Features/Mind%20ProjectionREL_PATH_SUFFIX), [Mind Recovery](REL_PATH_PREFIXRules/Features/Talent/4th-Level%20Features/Mind%20RecoveryREL_PATH_SUFFIX), Perk, Skill [Suspensor Field](REL_PATH_PREFIXRules/Features/Talent/4th-Level%20Features/Suspensor%20FieldREL_PATH_SUFFIX)                                                                                                                                                                                                                                                                | Two signature, 3, 5, 7        | 5                   |
...
| 7th   | [Ancestral Memory](REL_PATH_PREFIXRules/Features/Talent/7th-Level%20Features/Ancestral%20MemoryREL_PATH_SUFFIX), [Cascading Strain](REL_PATH_PREFIXRules/Features/Talent/7th-Level%20Features/Cascading%20StrainREL_PATH_SUFFIX), [Characteristic Increase](REL_PATH_PREFIXRules/Features/Talent/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Lucid Mind](REL_PATH_PREFIXRules/Features/Talent/7th-Level%20Features/Lucid%20MindREL_PATH_SUFFIX), Skill                                                                                                                                                                                                                                                                       | Two signature, 3, 5, 7, 9     | 5, 9                |
| 8th   | Perk, Tradition Feature, 11-Clarity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Two signature, 3, 5, 7, 9, 11 | 5, 9                |
| 9th   | [Fortress of Perfect Thought](REL_PATH_PREFIXRules/Features/Talent/9th-Level%20Features/Fortress%20of%20Perfect%20ThoughtREL_PATH_SUFFIX), Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
| 10th  | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Talent/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Clear Mind](REL_PATH_PREFIXRules/Features/Talent/10th-Level%20Features/Clear%20MindREL_PATH_SUFFIX), [Omnisensory](REL_PATH_PREFIXRules/Features/Talent/10th-Level%20Features/OmnisensoryREL_PATH_SUFFIX), Perk, [Psion](REL_PATH_PREFIXRules/Features/Talent/10th-Level%20Features/PsionREL_PATH_SUFFIX), Skill, [Vision](REL_PATH_PREFIXRules/Features/Talent/10th-Level%20Features/VisionREL_PATH_SUFFIX)                                                                                                                                                                                                     | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |

### 1st-Level Features

As a 1st-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.

#### Talent Tradition

Psionic abilities are grouped into categories according to their effects, with each category comprising one of many [talent traditions](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Talent%20TraditionREL_PATH_SUFFIX):
...
> **Power Roll + Presence:**
>
> - **≤11:** 2 + P corruption damage; P < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 3 + P corruption damage; P < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 5 + P corruption damage; P < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
>
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R cold damage; M < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (EoT)
> - **12-16:** 4 + R cold damage; M < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (EoT)
> - **17+:** 6 + R cold damage; M < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (EoT)
>
> **Strained:** You are [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of your next turn. Additionally, a target [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) by this ability is [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) instead.
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P psychic damage; I < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 + P psychic damage; I < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 9 + P psychic damage; I < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Reason:**
>
> - **≤11:** 3 + R damage; M < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
>
> **Strained:** You take 1d6 damage and are [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends).
...
As a 2nd-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
Your [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) tradition grants your choice of one of two heroic abilities.
...
> **Power Roll + Reason:**
>
> - **≤11:** 6 + R damage; M < WEAK, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
> - **12-16:** 10 + R damage; M < AVERAGE, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX)
> - **17+:** 14 + R damage; M < STRONG, [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) and can't stand (save ends)
>
...
> **Power Roll + Reason:**
>
> - **≤11:** 6 + R psychic damage; I < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P corruption damage; P < WEAK, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 5 + P corruption damage; the target is flung through time, and if P < AVERAGE, they are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 8 + P corruption damage; the target is flung through time, and if P < STRONG, they are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
>
...
> - **17+:** 5 damage
>
> **Strained:** You create five orbs, and you are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) while you have any orbs active.
...
> **Power Roll + Presence:**
>
> - **≤11:** 6 + P damage; P < WEAK, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 10 + P damage; P < AVERAGE, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
> - **17+:** 14 + P damage; P < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
>
...
As a 4th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
As a 5th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
>
> **Strained:** The target gains 2 surges. You are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends).
...
> - **17+:** 24 sonic damage
>
> **Strained:** If you obtain a tier 2 outcome or better, you are [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of your turn and each target is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of their turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** 10 + R psychic damage; R < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 14 + R psychic damage; R < AVERAGE, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 20 + R psychic damage; R < STRONG, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** While [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) this way, the target takes 3 psychic damage for each square they willingly leave.
>
> **Strained:** While [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) this way, the target instead takes 5 psychic damage for each square they willingly leave. You have a double bane on ability rolls made against the target while they are [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) this way.
...
As a 6th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
> | **📏 Melee 2**                  | **🎯 One enemy** |
>
> **Effect:** The target has damage weakness 5 until the end of your next turn. Whenever the target takes damage while they have this weakness, they are knocked [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX).
>
> **Strained:** This ability gains the Strike keyword as the vision hurts the target's psyche. You make a power roll, then are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends).
>
> **Power Roll + Presence:**
>
...
> **Power Roll + Presence:**
>
> - **≤11:** P < WEAK, the target is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the effect ends
> - **12-16:** P < AVERAGE, the target's speed is 0 until the effect ends
> - **17+:** P < STRONG, the target is [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) until the effect ends
>
> **Strained:** Any creature or object force moved in the area takes 2 corruption damage for each square of the area they enter. Creatures and objects [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) in the area can be force moved. You are [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) until the effect ends.
...
As a 7th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
Whenever you take damage from a strained effect or from having negative clarity, you can choose one enemy within distance of your [Mind Spike](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Mind%20SpikeREL_PATH_SUFFIX) ability to take the same damage.
...
As an 8th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
> **Trigger:** The target takes damage.
>
> **Effect:** The target is [teleported](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) to an unoccupied space adjacent to you, taking no damage and suffering no additional effects if this movement would get them out of harm's way.
>
> **Strained:** You can't target yourself, and you take the damage and any additional effects instead of the target.

#### Universal Connection

The range of your [Telepathic Speech](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Telepathic%20SpeechREL_PATH_SUFFIX) feature increases to anywhere on the same world.
...
> **Power Roll + Presence:**
>
> - **≤11:** 10 + P damage; P < WEAK, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 14 + P damage; P < AVERAGE, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 20 + P damage; P < STRONG, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
>
...
> | **📏 Ranged 10**                   | **🎯 Self or one ally** |
>
> **Effect:** The target has damage immunity 5 and can't be made [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) or [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) until the start of your next turn. Whenever the target force moves a creature or object while under this effect, the forced movement distance gains a +5 bonus.
>
> **Strained:** You can't use maneuvers (save ends).

### 9th-Level Features

As a 9th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
- You can't be made [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) or [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX).
...
> **Power Roll + Presence:**
>
> - **≤11:** 4 corruption damage; [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 6 corruption damage; [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 corruption damage; [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
...
>
> **Strained:** You are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends). If you scored a critical hit with this ability, you die.
...
> **Power Roll + Reason:**
>
> - **≤11:** R < WEAK, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **12-16:** R < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** R < STRONG, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
>
> **Strained:** You can't use this ability if doing so would cause you to have negative clarity.

### 10th-Level Features

As a 10th-level [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), you gain the following features.
...
The whole world's a stage, and everyone on it, an actor. No one knows this better than the [troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX). You find energy in the [drama](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/DramaREL_PATH_SUFFIX) of everyday life and know how to draw spectacle forth from even the most mundane of situations. You accent highs and deepen lows in service to whoever might witness your performance.

**As a [troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX), you chase [drama](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/DramaREL_PATH_SUFFIX). The insurmountable dangers of the world might cause many a hero to cower. But you take to that world stage not intending to die, but to find out if you are truly alive.**
...
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ------------------- |
| 1st   | [Troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX) Class Act, [Drama](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/DramaREL_PATH_SUFFIX), Kit, [Scene Partner](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/Scene%20PartnerREL_PATH_SUFFIX), [Routines](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/RoutinesREL_PATH_SUFFIX), Class Act Features, [Class Act Triggered Action](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/Class%20Act%20Triggered%20ActionREL_PATH_SUFFIX), [Troubadour](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX) Abilities | Signature, 3, 5           | -                   |
| 2nd   | [Appeal to the Muses](REL_PATH_PREFIXRules/Features/Troubadour/2nd-Level%20Features/Appeal%20to%20the%20MusesREL_PATH_SUFFIX), [Invocation](REL_PATH_PREFIXRules/Features/Troubadour/2nd-Level%20Features/InvocationREL_PATH_SUFFIX), Perk, Class Act Ability                                                                                                                                                                                                                                                                                                                                                                                       | Signature, 3, 5           | 5                   |
| 3rd   | Class Act Feature, 7-Drama Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7        | 5                   |
| 4th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Troubadour/4th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Melodrama](REL_PATH_PREFIXRules/Features/Troubadour/4th-Level%20Features/MelodramaREL_PATH_SUFFIX), Perk, Skill, [Zeitgeist](REL_PATH_PREFIXRules/Features/Troubadour/4th-Level%20Features/ZeitgeistREL_PATH_SUFFIX)                                                                                                                                                                                                                                                                                            | Signature, 3, 5, 7        | 5                   |
| 5th   | Class Act Feature, 9-Drama Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5                   |
| 6th   | Perk, Spotlight, Class Act Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5, 9                |
| 7th   | [Characteristic Increase](REL_PATH_PREFIXRules/Features/Troubadour/7th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [A Muse's Muse](REL_PATH_PREFIXRules/Features/Troubadour/7th-Level%20Features/A%20Muses%20MuseREL_PATH_SUFFIX), [Equal Billing](REL_PATH_PREFIXRules/Features/Troubadour/7th-Level%20Features/Equal%20BillingREL_PATH_SUFFIX), Skill                                                                                                                                                                                                                                                                             | Signature, 5, 7, 9        | 5, 9                |
| 8th   | Perk, Class Act Feature, 11-Drama Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
| 9th   | [Roar of the Crowd](REL_PATH_PREFIXRules/Features/Troubadour/9th-Level%20Features/Roar%20of%20the%20CrowdREL_PATH_SUFFIX), Class Act Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
| 10th  | [Applause](REL_PATH_PREFIXRules/Features/Troubadour/10th-Level%20Features/ApplauseREL_PATH_SUFFIX), [Characteristic Increase](REL_PATH_PREFIXRules/Features/Troubadour/10th-Level%20Features/Characteristic%20IncreaseREL_PATH_SUFFIX), [Dramaturgy](REL_PATH_PREFIXRules/Features/Troubadour/10th-Level%20Features/DramaturgyREL_PATH_SUFFIX), [Greatest of All Time](REL_PATH_PREFIXRules/Features/Troubadour/10th-Level%20Features/Greatest%20of%20All%20TimeREL_PATH_SUFFIX), Perk, Skill                                                                                                                                                       | Signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
...
- **Duelist:** [Drama](REL_PATH_PREFIXRules/Features/Troubadour/1st-Level%20Features/DramaREL_PATH_SUFFIX) infuses your every movement done in tandem with another. You perform dances of death, putting trust in your opponent to return your passion in kind. You have the Gymnastics skill.
...
Choose one signature ability from the following options. Signature abilities can be used at will. (*Quick Build:* [Witty Banter](REL_PATH_PREFIXRules/Abilities/Troubadour/1st-Level%20Features/Witty%20BanterREL_PATH_SUFFIX).)
...
You gain 1 additional drama or other Heroic Resource whenever you use your [Appeal to the Muses](REL_PATH_PREFIXRules/Features/Troubadour/2nd-Level%20Features/Appeal%20to%20the%20MusesREL_PATH_SUFFIX) feature. Additionally, your performances no longer have a distance, but can affect any target on the encounter map within your line of effect.
