...
Some abilities don't cost your Heroic Resource to use but allow you to spend your Heroic Resource to enhance or add effects to the ability, such as the [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX)'s [Healing Grace](REL_PATH_PREFIXRules/Abilities/Conduit/1st-Level%20Features/Healing%20GraceREL_PATH_SUFFIX). These abilities are not heroic abilities unless the baseline ability can't be used without spending your Heroic Resource.
...
When an ability can target creatures and objects, the ability can damage objects. However, unless otherwise noted (as with the [talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX)'s [Minor Telekinesis](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/Minor%20TelekinesisREL_PATH_SUFFIX) ability) or if the Director allows it, objects are immune to an ability's other effects. If an ability forces an object to make a test, the object automatically gets a tier 1 result on the test.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ---------------- |
| 1st   | [Deity and Domains](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/Deity%20and%20DomainsREL_PATH_SUFFIX), [Piety](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/PietyREL_PATH_SUFFIX), Domain Feature, [Healing Grace](REL_PATH_PREFIXRules/Abilities/Conduit/1st-Level%20Features/Healing%20GraceREL_PATH_SUFFIX), [Ray of Wrath](REL_PATH_PREFIXRules/Abilities/Conduit/1st-Level%20Features/Ray%20of%20WrathREL_PATH_SUFFIX), Triggered Action, [Prayer](REL_PATH_PREFIXRules/Features/Conduit/1st-Level%20Features/PrayerREL_PATH_SUFFIX), Conduit Ward, Conduit Abilities | Two signature, 3, 5           | -                |
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------------- |
| 1st   | Null Tradition, [Discipline](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/DisciplineREL_PATH_SUFFIX), Null Field, [Inertial Shield](REL_PATH_PREFIXRules/Abilities/Null/1st-Level%20Features/Inertial%20ShieldREL_PATH_SUFFIX), [Discipline Mastery](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/Discipline%20MasteryREL_PATH_SUFFIX), Null Speed, [Psionic Augmentation](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Psionic%20AugmentationREL_PATH_SUFFIX), [Psionic Martial Arts](REL_PATH_PREFIXRules/Features/Null/1st-Level%20Features/Psionic%20Martial%20ArtsREL_PATH_SUFFIX), Null Abilities | Two signature, 3, 5           | -                   |
...
Whenever you use your [Inertial Shield](REL_PATH_PREFIXRules/Abilities/Null/1st-Level%20Features/Inertial%20ShieldREL_PATH_SUFFIX) triggered action, you gain immunity to acid, cold, corruption, fire, lightning, poison, and sonic damage equal to your Intuition score against the triggering damage.
...
You can target two creatures simultaneously with your [Careful Observation](REL_PATH_PREFIXRules/Abilities/Shadow/3rd-Level%20Features/Careful%20ObservationREL_PATH_SUFFIX) ability, observing both simultaneously. Making a strike against one target doesn't end your observation of the other target.
...
| Level | Features                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Abilities                     | Tradition Abilities |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) Tradition, [Clarity and Strain](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Clarity%20and%20StrainREL_PATH_SUFFIX), [Mind Spike](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/Mind%20SpikeREL_PATH_SUFFIX), [Psionic Augmentation](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Psionic%20AugmentationREL_PATH_SUFFIX), Talent Ward, [Telepathic Speech](REL_PATH_PREFIXRules/Features/Talent/1st-Level%20Features/Telepathic%20SpeechREL_PATH_SUFFIX), Tradition Features, [Talent](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX) Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Two signature, 3, 5           | 5                   |
