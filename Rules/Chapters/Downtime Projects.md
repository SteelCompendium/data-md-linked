...
As a team, you and your fellow heroes can achieve great things. But the time between adventures gives you a chance to pursue your own individual goals: uncover forbidden lore in ancient tomes, forge weapons of great power, build ships that can sail the skies, and more. *Draw [Steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX)*'s rules for downtime projects allow heroes to use their time during respites to obtain important information, make new equipment, and engage in other activities to support their adventuring.
...
You track project progress on your character sheet. As you work on a downtime project, you might [look](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) over old books that you've found in your travels, perform experiments, converse with experts and scholars, or work with tools to create something.
...
An airship is an object (giving it damage immunity all to poison and psychic damage) and can take 200 damage before it is destroyed. If the damage the ship takes is not too severe (as the Director determines), as long as you have access to materials that can repair the ship, you can restore it [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to its original condition as a respite activity.
...
| 6   | After the roll, word is heard that not everyone in the local area is happy about the road being built. The project is hindered by supernatural curses that cause stones to move, vines and overgrowth to reclaim sections already built, or churning earth to restore the road [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to its previous form. The hero must make amends to the local supernatural community or have the renown earned by completing the project not extend to that community. |
...
| 9   | Before the roll, the proposed road touches on a supernatural intersection—a crossing place between multiple worlds that draws interest from a powerful [devil](REL_PATH_PREFIXRules/Ancestries/DevilREL_PATH_SUFFIX). The completion of the project becomes the personal interest of this being, who offers to increase progress—but demands a future favor from the hero. If the deal is accepted, each project roll for the project is doubled until its completion.                                                                    |
...
**Nettlebloom:** Whenever you are [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) by an adjacent creature, your armor sprouts toxic nettles. While that creature has you [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX), they are [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX).
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ | ----------------------- |
| [Awe](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/AweREL_PATH_SUFFIX) | A lock of hair from a fey, taken in amicable bargain for Charming or in violence for Threatening | Khelt                   |
...
**Leyline Walker:** Once per turn as a move action, you can spend any amount of your movement to instead [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) that distance.
...
On your turn, you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) to the imprint's space as a free maneuver. When you are targeted by an ability, you can use a free triggered action to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) to your imprint, and the power roll for the ability is an automatic tier 1 result.

**Unbending:** You can't be subjected to forced movement unless you choose to be. Effects that ignore [Stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) also ignore this enhancement.
...
An implement imbued with an enhancement grants you special benefits while it is wielded. Additionally, when an implement receives its 1st-level enhancement, it grants your magic or psionic abilities that deal rolled damage a +1 damage bonus. A 5th-level enhancement increases the bonus to +2, and a 9th-level enhancement increases it to +3. [Censors](REL_PATH_PREFIXRules/Classes/CensorREL_PATH_SUFFIX), [conduits](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), [elementalists](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX), [nulls](REL_PATH_PREFIXRules/Classes/NullREL_PATH_SUFFIX), [talents](REL_PATH_PREFIXRules/Classes/TalentREL_PATH_SUFFIX), and [troubadours](REL_PATH_PREFIXRules/Classes/TroubadourREL_PATH_SUFFIX) benefit from using implements more than the other [classes](REL_PATH_PREFIXRules/Chapters/ClassesREL_PATH_SUFFIX) in this book.
...
**Displacing I:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) that creature up to 2 squares after the ability's effects resolve. If the creature started on a horizontal surface, they must end on a horizontal surface.
...
**Celerity:** Immediately after using a magic or psionic ability that requires a main action, you can shift up to 3 squares, or you can use the [Escape Grab](REL_PATH_PREFIXRules/Abilities/Common/Maneuvers/Escape%20GrabREL_PATH_SUFFIX) maneuver as a free maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)).

**Celestine:** As a main action, you conjure up to three stars, which [hover](REL_PATH_PREFIXRules/Movement/HoverREL_PATH_SUFFIX) in unoccupied squares of your choice within 5 squares of you. The stars remain in place, and disappear if you create more stars. When an enemy enters any star's space, the star detonates and is destroyed, and the enemy takes 10 fire damage. If you have line of effect to the enemy, you can also slide them 1 square. Otherwise, the enemy slides 1 square in a random direction.

**Displacing II:** When you use the implement's Displacing I enhancement, you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the creature up to 4 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.
...
**Anathema:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, that creature is also [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends). If the creature is within 10 squares when this [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) effect ends, you can use a free triggered action to make a [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) against them.

**Displacing III:** When you use the implement's Displacing I enhancement, you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) the creature up to 5 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.

**Erupting II:** The fire damage dealt by the implement's Erupting I enhancement increases to 6.

**Forceful III:** Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares and that movement can be [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX). This replaces the benefit of Forceful II.
...
| Piercing         | Black [iron](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/IronREL_PATH_SUFFIX) harvested from a slain blood elemental | Anjali                  |
...
>
> **Chilling II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 cold damage and is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends). This replaces the benefit of Chilling I.
>
...
>
> **Terrifying II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 4 psychic damage and is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends). This replaces the benefit of Terrifying I.
>
> **Thundering II:** Whenever you deal rolled damage to a creature using this weapon, you can push that creature up to 3 squares after the other effects of the ability resolve. If you obtained a tier 3 outcome, the creature is also knocked [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) after being pushed. This replaces the benefit of Thundering I.
>
...
| Thundering II | An [iron](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/IronREL_PATH_SUFFIX) rod charged by the death throes of an essence of storms | Low Kuric               |
...
**Chilling III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 9 cold damage and is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends). This replaces the benefit of Chilling II.

**Disrupting III:** Whenever you damage an undead using this weapon and leave that undead with 50 Stamina or less, they immediately drop to 0 Stamina. If you instead leave the undead with 100 Stamina or less, they are [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends). This replaces the benefit of Disrupting II.

**Draining:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends). Each time you weaken a creature with this weapon, you gain 1 surge.

**Imprisoning:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) (save ends). While [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) in this way, the creature can't use magic or psionic abilities.
...
> - **17+:** 16 fire damage
>
> **Terrifying III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 psychic damage and is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends). This replaces the benefit of Terrifying II.
>
> **Thundering III:** Whenever you deal rolled damage to a creature using this weapon, you can [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX) push that creature up to 5 squares and knock them [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) after the other effects of the ability resolve. If the creature takes or deals damage as a result of this movement, they also take 5 thunder damage. This replaces the benefit of Thundering II.
>
...
>
> **Windcutting:** Whenever you use a melee signature ability that usually targets one creature, you can take a bane on the ability to target each enemy in a cube 3 within distance. If your signature ability would usually cause its target to become [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) or [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX), each target in the area is instead [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of their next turn.
...
Lost knowledge is so esoteric that even among a field's most dedicated scholars, there might be only one or two individuals who have dug deep enough to know that lore. Lost knowledge could come from a time so long ago that only a single text in a dead language [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) holds the lore you seek. Such lore often takes more than a week to hunt down. The location of a legendary [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) [dwarf](REL_PATH_PREFIXRules/Ancestries/DwarfREL_PATH_SUFFIX)'s workshop is most likely lore that is lost—except for one map hidden in a private collection.
...
| 13-14  | Before the roll, a rumor [arises](REL_PATH_PREFIXRules/Abilities/Conduit/8th-Level%20Features/AriseREL_PATH_SUFFIX) that the project is being worked on in service to an evil entity. People start showing up to the hero's place of respite, demanding that they [repent](REL_PATH_PREFIXRules/Abilities/Censor/1st-Level%20Features/RepentREL_PATH_SUFFIX) their wicked ways. If the rumors aren't disproved, locals form a mob to stop the project.                                                          |
...
| 43-44  | After the roll, an otherworldly specter appears and warns the hero not to complete the project, explaining that they died attempting the same project and are [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) attached to the project source. If the hero can convince the spirit that they will not die similarly, the creature shares their knowledge, contributing one project roll to the project with a +3 modifier.                                               |
...
| d10 | Event                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Before the roll, an old colleague from the hero's past asks the hero to give up adventuring and come [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to their former career. A hero who reaffirms their intent to remain a hero gains a hero token. However, if they do so—or if they lie to say they will return to their old career—the project goal increases by 50 points as their old colleague refuses to help them. |
...
| 10  | After the roll, the hero gets [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) into the rhythm of their former career. They can make two additional project rolls.                                                                                                                                                                                                                                                          |
...
You gain one signature ability of your choice from the master's class (gaining a second signature ability if the master is of the same class as you). If the master is a [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX), you can gain the [Strike Now](REL_PATH_PREFIXRules/Features/Tactician/1st-Level%20Features/Strike%20NowREL_PATH_SUFFIX) ability instead. You can't gain this benefit again for the same class.
...
| Ancient or lost | Rare or extinct ingredients (honeylilies, [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) apples, and so forth) | Supernatural power |
...
| 7   | After the roll, a saint blesses the hero's work. The hero feels supernaturally rejuvenated, increasing their Recoveries by 1 until the end of their next respite. If the character is a [conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX), they also gain an automatic breakthrough on the project.                                                                                                                 |
...
| 10  | Before the roll, a thief, assassin, or other criminal offers to assist the hero. They can offer 50 points toward the completion of the project, as long as the hero [looks](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) the other way if they ever cross paths again.                                                                                                                        |
...
| 4   | After the roll, the hero learns that a distant friend or family member has joined the cause of their enemies. Their loved ones plead with the hero to bring this person [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) home safely.                                                                                                       |
