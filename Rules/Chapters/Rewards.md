...
**Effect:** Dousing yourself in this powder as a maneuver causes you to weightlessly float off the ground. For 1 hour, your stability is reduced to 0, and you can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) and [hover](REL_PATH_PREFIXRules/Movement/HoverREL_PATH_SUFFIX). Additionally, the hag that the powder is sourced from knows exactly where and when you use it.
...
- *Headbutt:* While you are [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) or [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX), your free strikes don't take a bane when those conditions would impose one.
...
- *Foes as Weapons:* Whenever you have a creature of your size or smaller [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX), you can use them as a weapon when you make a melee weapon free strike. Both the target and the [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) enemy take the strike's damage.
