...
You've helped save the world! Or at least a corner of that world important to you. [Now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) you deserve the treasures that can help you do so even more efficiently next time. So claim your magic sword, psionic shield, and Catapult Dust, and ride to your next adventure!
...
Though body keywords indicate where a treasure is meant to be worn, treasures can still function if worn on other parts of the body. For example, a hero without ears or who just wants to have a different [look](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) might wear an earring as a piercing anywhere else they desire.
...
>
> Languages: [Chapter 4: Background](REL_PATH_PREFIXRules/Chapters/BackgroundREL_PATH_SUFFIX)
>
> Abilities, conditions, potencies, surges: Chapter 5: [Classes](REL_PATH_PREFIXRules/Chapters/ClassesREL_PATH_SUFFIX)
>
...
**Effect:** As a maneuver, you rub the balm on your body and feel it tingle across your skin. You immediately end the [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) and [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) conditions on yourself, and you gain a +2 bonus to speed until the start of your next turn.
...
**Effect:** As a maneuver, you can drink this potion or pour it over an object of size 2 or smaller, causing the target's size to increase by 1(to a minimum size of 2). If you are the target, your Stamina maximum and [Stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) are doubled, you gain an edge on Might tests, and your weapon abilities that deal rolled damage gain a damage bonus equal to your highest characteristic score. You shrink [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to your original size after 3 rounds, halving your current Stamina maximum and [Stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX), and losing the potion's other benefits. Objects maintain their new size permanently.
...
**Effect:** When activated as a maneuver, this item erupts in a bright flash, you can shift 1 square without your enemies noticing your movement, and a homunculus perfectly resembling you appears in an adjacent space. The homunculus is a creature with Stamina 15, a 0 in all their characteristics, and a speed and [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) equal to yours. They appear indistinguishable from you but can't use any abilities.
...
**Effect:** As a maneuver, you sprinkle a dose of this powder onto food or drink, or blow it at an adjacent creature who is [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX), [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX), or unconscious. A creature who is exposed to blown powder (even if they hold their breath) or consumes a dose of the powder must communicate in only true statements for 1 hour. Additionally, other creatures gain an edge on Intuition and Presence tests made to convince the target to communicate, or to read the target's emotions. Any such creature has a double edge on the test if the target doesn't realize they've been affected by the snuff.
...
**Effect:** When you consume this delicious piece of candy as a maneuver, you gain 15 temporary Stamina and a +10 bonus to [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX). Additionally, if you don't use your movement during your turn, any strikes you make on that turn deal an extra 5 damage, and any strikes against you take a bane until the start of your next turn. This effect and the bonus to [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) lasts until the end of the encounter, after which you are sleepy. If not reduced beforehand, the temporary Stamina lasts until the end of your next respite.
...
**Effect:** Dousing yourself in this powder as a maneuver causes you to weightlessly float off the ground. For 1 hour, your [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) is reduced to 0, and you can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) and [hover](REL_PATH_PREFIXRules/Movement/HoverREL_PATH_SUFFIX). Additionally, the hag that the powder is sourced from knows exactly where and when you use it.
...
- **Size 1L or smaller:** [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX) pull 6
- **Size 2:** [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX) pull 3
- **Size 3:** [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX) pull 1
...
**Effect:** When you release the larva as a maneuver, it feeds on psychic energy to grow exponentially, creating a 10 wall of larval flesh adjacent to you. The wall can't be created to fill any square occupied by a creature with [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) 1 or higher. Each other creature in the wall when it is created is pushed to the nearest unoccupied space.
...
**Effect:** As a maneuver, you spend 1 Heroic Resource to destroy this page and create a 4-cube area within 20 squares. The area is filled with the energy of a tiny sun that lasts until the end of the encounter. Any creature who enters the area for the first time in a combat round or starts their turn there takes 20 fire damage and is [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) until the end of their turn.
...
**Effect:** While you wear these gloves, your grip is all but impossible to break. You can't be disarmed, you can't lose your grip while [climbing](REL_PATH_PREFIXRules/Movement/Climb%20or%20SwimREL_PATH_SUFFIX) unless you are force moved, and any creature [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) by you takes a bane on the test for the [Escape Grab](REL_PATH_PREFIXRules/Abilities/Common/Maneuvers/Escape%20GrabREL_PATH_SUFFIX) maneuver.

##### Hellcharger Helm

*A [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) helm is set with two curved ebony horns, a crackling plume of fire floating between them.*

**Keywords:** Head, Magic

**Item Prerequisite:** One broken contract, one ingot of [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX)
...
**Effect:** While worn, this belt grants you a +3 bonus to Stamina and a +1 bonus to [Stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX). This Stamina bonus adds to the Stamina bonus granted by other treasures.
...
**Effect:** Once per turn, you can use a maneuver to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up to 3 squares. Additionally, when targeted by any other effect that causes you to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX), you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up to 3 additional squares.
...
**1st Level:** While you wear this armor, you gain a +6 bonus to Stamina and you can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX). If you don't end your turn on the ground, you fall.
...
**9th Level:** The armor's bonus to Stamina increases to +21. Additionally, if you [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX) any distance before making a strike, that strike gains an edge.
...
**9th Level:** The shield's bonus to Stamina increases to +9. When you cause the shield to roar, you target one creature or object within 6 squares, you push that target up to 5 squares, and the target is [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of their next turn.
...
**1st Level:** While you wear this armor, you gain a +6 bonus to Stamina. Additionally, you can use a main action to fold in on yourself until you and your gear are paper thin. This effect lasts for 1 minute, letting you easily slip through any opening that is 1 inch wide or more. When you return to your three-dimensional form, you are [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) for 1 minute. If you return to your true form while in a space that is too small for you, you are violently expelled into the nearest open space of your choice and take 3d6 damage.

**5th Level:** The armor's bonus to Stamina increases to +12, and when you return to your true form, you are [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) only until the end of your next turn. Additionally, while you are paper thin, you can use a maneuver to wrap yourself around an adjacent target who is the same size or smaller than you, automatically grabbing them.

**9th Level:** The armor's bonus to Stamina increases to +21, and you are no longer [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) when you return to your true form. Additionally, while you have a target [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) when you are paper thin, you can use a maneuver to constrict the target, dealing 10 damage to them. A creature damaged this way takes a bane when using the [Escape Grab](REL_PATH_PREFIXRules/Abilities/Common/Maneuvers/Escape%20GrabREL_PATH_SUFFIX) maneuver against you and when making strikes against you.
...
**5th Level:** The armor's bonus to Stamina increases to +12. Additionally, whenever you take damage, you can use a triggered action to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up to 5 squares. If you do, you create an illusion of you dying in your previous space, which fades at the end of your next turn.

**9th Level:** The armor's bonus to Stamina increases to +21. Whenever you use the armor's triggered action to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX), you can [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up to a number of squares equal to the damage taken (minimum 5 squares). Additionally, if a creature dealt you the triggering damage, you become invisible to that creature until the end of your next turn.
...
**Item Prerequisite:** Ten [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) gears from an ancient construct
...
**1st Level:** While you wear this armor, you gain a +6 bonus to Stamina. Additionally, you can use a main action to expand the armor on your [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) to create a 4 wall of metal behind you. The wall is an object that retracts if you move, or if it takes 15 damage. It then requires a main action to recalibrate before it can be deployed again.
...
*An unseen force seems to draw this [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX) shield toward nearby creatures.*

**Keywords:** Psionic, Shield

**Item Prerequisite:** Three ingots of [steel](REL_PATH_PREFIXRules/Abilities/Talent/8th-Level%20Features/SteelREL_PATH_SUFFIX), six crystals that resonate with psionic power
...
**9th Level:** The shield's bonus to Stamina increases to +9. Additionally, you can use a maneuver to pull any number of targets the shield has [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) up to 5 squares.
...
**9th Level:** The implement's damage bonus increases to +3. Additionally, whenever you deal 30 or more rolled damage with a magic or psionic ability to a creature whose senses you are using, that creature is [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) until the end of their next turn.
...
**5th Level:** The weapon's damage bonus increases to +2. Additionally, when you make an opportunity attack against an enemy of your size or smaller, you can use fancy footwork to knock them [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX). You also earn 1 Renown.
...
**1st Level:** Any weapon ability that deals rolled damage using this weapon deals an extra 1 psychic damage. Additionally, whenever you deal rolled damage to a creature, you can use a maneuver to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) you and that creature, letting you trade places provided you both fit into each other's spaces.
...
**1st Level:** Any weapon ability that deals rolled damage using this weapon deals an extra 1 poison damage. Additionally, any signature ability using the weapon that obtains a tier 3 outcome also makes the target [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) until the end of their next turn.

**5th Level:** The weapon's extra poison damage increases to 2. A signature ability made using the weapon that obtains a tier 3 outcome also makes the target [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) and [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) until the end of their next turn.
...
**1st Level:** You gain a +1 bonus to melee distance with weapon abilities using this weapon. Additionally, any damage-dealing weapon ability using the weapon against a target who has A < AVERAGE also leaves that target [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends).

**5th Level:** The weapon's bonus to melee distance increases to +2. Additionally, any weapon ability that deals rolled damage using the weapon gains a +3 damage bonus against any target who is [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX).

**9th Level:** The weapon's bonus to melee distance increases to +3. Additionally, if you use a signature ability using the weapon that targets one or more [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) creatures, you can use the same ability again immediately as a maneuver.
...
**1st Level:** Any weapon ability that deals rolled damage using this weapon deals an extra 1 psychic damage. Additionally, any damage-dealing weapon ability using the weapon that achieves a tier 3 outcome also leaves the target [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) until the end of their next turn. **5th Level:** The weapon's extra psychic damage increases to 2. Additionally, whenever a creature within distance of your ranged weapon [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) uses a triggered action, you can use a triggered action after their triggered action resolves to make a ranged weapon [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) using this weapon against the creature.
...
**1st Level:** Any weapon ability that deals rolled damage using this weapon deals an extra 1 psychic damage. Additionally, if you reduce a creature to 0 Stamina using this weapon, you can immediately use a maneuver to make a melee [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX).

**5th Level:** The weapon's extra psychic damage increases to 2. Additionally, if you reduce a creature to 0 Stamina using the weapon, you can use a maneuver to make a melee [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) and can move up to 2 squares before or after the strike.

**9th Level:** The weapon's extra psychic damage increases to 3. Additionally, if you reduce a creature to 0 Stamina using the weapon, you can use a maneuver to move up to your speed and make either a signature ability strike or a melee [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX).
...
**9th Level:** The ring's bonus to Stamina increases to +21. Additionally, if a creature bonded with you dies, you can choose to die in their place. Your sacrifice twists [fate](REL_PATH_PREFIXRules/Abilities/Talent/6th-Level%20Features/FateREL_PATH_SUFFIX) to remove the creature from danger, and they regain Stamina equal to their winded value. Your ring then [teleports](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) into their possession and ceases to be magic.
...
**1st Level:** While you wear this cloak, any creature who damages you is marked for revenge until the end of your next turn or until another creature damages you. Any strike you make against a creature marked for revenge deals extra damage equal to your highest characteristic score, and whenever you damage a creature marked for revenge, they are also [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) until the end of their next turn.

**5th Level:** Each creature who damages you is marked for revenge until the end of your next turn. Whenever you damage a creature marked for revenge, they are also [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends).
...
**Turn the Tide:** Each enemy minion within 1 mile of the sword is [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX). Any enemy leader or solo creature in that area takes a bane on ability rolls.
...
The [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) is said to have first manifested in a young world doomed to apocalypse—unless every last inhabitant of that world could stand together. The scepter is said to impose either dominion or obliteration over any threat its light is drawn around. Today, it is most commonly known as a bad omen, and should the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) reveal itself, folk know that the world teeters on the brink of destruction. Whether any of the stories are true, few can say, for the only living eyes that have witnessed the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) belong to dragons deep in slumber.

**Shining Presence:** The one who wields the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) is always cast in a brilliant glow. Any power roll made by the wielder that uses Presence automatically achieves a tier 3 outcome, though the wielder can still roll in an attempt to score a critical success or critical hit.

**Champion's Lasso:** As a free maneuver, the wielder of the scepter can trigger a glowing line of light that traces their path as they move, or can dismiss the glowing line. If the wielder crosses over this line, each creature and object of the wielder's choice enclosed inside the line and within 2 squares above and below it are considered lassoed by the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX). Creatures remain lassoed until the lasso is released or until a new line is drawn.

**Dominion:** Each creature lassoed by the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) is [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX) and can't [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX). A creature caught in midair while lassoed stays in place rather than falling.

**Obliteration:** As a main action, the wielder raises the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) to the sky. Each target lassoed by the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) erupts in a prismatic burst of light, taking 10 psychic damage for each square horizontally encircled by the lasso. The lasso is then immediately released.

**At World's End:** If the [Encepter](REL_PATH_PREFIXRules/Treasures/Artifacts/EncepterREL_PATH_SUFFIX) was not taken from its cyclonic resting place with the purpose of vanquishing a terrible peril, then a terrible peril emerges to threaten the world within 3 days of the scepter being taken.
...
Some titles have only one benefit. These are typically earned by heroes individually instead of together as a group. Only the hero doing the studying or meeting a particular [fate](REL_PATH_PREFIXRules/Abilities/Talent/6th-Level%20Features/FateREL_PATH_SUFFIX) [reaps](REL_PATH_PREFIXRules/Abilities/Conduit/2nd-Level%20Features/ReapREL_PATH_SUFFIX) the reward!
...
*It's astonishing what you find in old books. [Look](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) at this—nearly complete schematics for a war automaton, gathering dust because nobody here reads Zaliac.*
...
- *Headbutt:* While you are [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) or [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX), your [free strikes](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) don't take a bane when those conditions would impose one.
...
**Prerequisite:** You fight alongside three or more [dwarves](REL_PATH_PREFIXRules/Ancestries/DwarfREL_PATH_SUFFIX).

**Effect:** Choose one of the following benefits:

- *Close Formation:* While adjacent to two or more allies, you gain a +2 bonus to [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX).
...
- *Oh No, You Don't!:* Whenever an adjacent creature uses an ability with the Magic keyword, you can make a [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) against them as a triggered action.
...
The Director chooses one of the following benefits, based on the [fate](REL_PATH_PREFIXRules/Abilities/Talent/6th-Level%20Features/FateREL_PATH_SUFFIX) your captors have in mind for you. Each hero gains the same benefit. Additionally, you must face an encounter, montage test, or adventure related to the benefit, as the Director determines.
...
- *No, You're Under [Arrest](REL_PATH_PREFIXRules/Abilities/Censor/1st-Level%20Features/ArrestREL_PATH_SUFFIX)!:* You gain an edge on the [Escape Grab](REL_PATH_PREFIXRules/Abilities/Common/Maneuvers/Escape%20GrabREL_PATH_SUFFIX) maneuver. Additionally, when you succeed on a test to escape bonds or manacles, as part of the same maneuver, you can transfer the bonds or manacles to an adjacent creature of the same size without them immediately noticing.

#### Zombie Slayer

*Why won't you die?! You've already done it once, you should be good at it by [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX)!*
...
>
> **Effect:** Each target takes holy damage equal to your Reason, Intuition, or Presence score (your choice). Additionally, each target who has P < STRONG is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends).
...
- *Dirty Fighting:* While you are standing, your melee strikes gain a +3 damage bonus against [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) creatures. Additionally, being [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX) doesn't impose a bane on your strikes.
- *Foes as Weapons:* Whenever you have a creature of your size or smaller [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX), you can use them as a weapon when you make a melee weapon [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX). Both the target and the [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) enemy take the strike's damage.
...
> **Power Roll + Might or Agility:**
>
> - **≤11:** 6 damage; I < WEAK, [slowed](REL_PATH_PREFIXRules/Conditions/SlowedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 10 damage; I < AVERAGE, [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 14 damage; I < STRONG, [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** If you kill a non-minion opponent using this ability, each enemy within 3 squares of you is [frightened](REL_PATH_PREFIXRules/Conditions/FrightenedREL_PATH_SUFFIX) (save ends).
...
*Flow, blood, thou fiend's libation, and catch my foes in [conflagration](REL_PATH_PREFIXRules/Abilities/Elementalist/1st-Level%20Features/ConflagrationREL_PATH_SUFFIX)!*
...
*Come [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) here, puny one, and let me crush you!*
...
*He seemed like he needed help! [Now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) the dead speak to me. I think maybe that old man was more than he appeared.*
...
> **Power Roll + Might or Agility:**
>
> - **≤11:** 7 damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (save ends)
> - **12-16:** 11 damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (save ends)
> - **17+:** 16 damage; [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) (save ends)
>
> **Effect:** You can end the [taunted](REL_PATH_PREFIXRules/Conditions/TauntedREL_PATH_SUFFIX) condition on the target as a free maneuver.
>
...
*And this is interesting... if you twist the third button on your overcoat no, don't do it [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX)!*
...
- *We're In This Together:* When you have a creature [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) and take damage from an ability not used by that creature, the [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) creature takes the same damage.
...
- *Ghoul or Vampire:* When you make a melee [free strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX) against an adjacent creature, you can bite that creature. If you do so and obtain a tier 3 outcome, you gain temporary Stamina equal to the damage dealt. If not lost beforehand, this temporary Stamina lasts until the end of your next respite.
...
- *Other Corporeal Undead:* When you are reduced to 0 Stamina by damage that isn't fire or holy damage and your body isn't destroyed, you can regain half your Stamina and fall [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX). Once you use this benefit, you can't use it again until you earn 10 or more Victories.

#### Unstoppable

*I seen the goblin king run 'im through with a spear. Then I seen 'im pull 'imself [back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) up, spear still in 'im, and headbutt the goblin king... then he pulls out the spear and throws it on the goblin king's corpse.*
...
**Prerequisite:** You die at the hands of your greatest foe, that foe still lives, and you aren't a [revenant](REL_PATH_PREFIXRules/Ancestries/RevenantREL_PATH_SUFFIX).

**Effect:** You are restored to life. You gain the Tough But Withered signature trait from the [revenant](REL_PATH_PREFIXRules/Ancestries/RevenantREL_PATH_SUFFIX) ancestry.
...
> - **12-16:** 6 sonic damage; M < AVERAGE, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) (save ends)
> - **17+:** 10 sonic damage; M < STRONG, [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) and [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) (save ends)
>
...
- *Prismacore Eyes:* Exposure to prismacore has given your eyes a mirrorlike sheen. You have psychic immunity 10, creatures can't use magic or psionic abilities or other effects to determine your location or read your thoughts unless you allow them to, and you gain a +3 bonus to [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX) against magic or psionic abilities.
...
*Last time we fought, I gave you a little token to remember me by... [now](REL_PATH_PREFIXRules/Abilities/Tactician/1st-Level%20Features/NowREL_PATH_SUFFIX) it appears you need another reminder of my power.*
...
- *Hold the Line:* While you're within 5 squares of an ally, you and each ally within 5 squares of you gains a +3 bonus to [stability](REL_PATH_PREFIXRules/Movement/StabilityREL_PATH_SUFFIX).
...
*Someday, I'll understand how peeling these carrots for dinner relates to my [elementalist](REL_PATH_PREFIXRules/Classes/ElementalistREL_PATH_SUFFIX) training.*
...
*Marduk uses the Beldoit Gambit! Avanna counters with the [Iron](REL_PATH_PREFIXRules/Abilities/Talent/1st-Level%20Features/IronREL_PATH_SUFFIX) Defense and goes on the attack! Marduk's last tower is knocked down! And just like that, we have a new... world... champion!*
...
**Prerequisite:** You conduct a successful negotiation on which the [fate](REL_PATH_PREFIXRules/Abilities/Talent/6th-Level%20Features/FateREL_PATH_SUFFIX) of a nation or a world stands.
...
**Special:** If a [hakaan](REL_PATH_PREFIXRules/Ancestries/HakaanREL_PATH_SUFFIX) gains this title as a result of using their Doomsight trait, they lose that trait.

#### Theoretical Warrior

*I've read about this tactic in books—it [looks](REL_PATH_PREFIXRules/Abilities/Shadow/6th-Level%20Features/LookREL_PATH_SUFFIX) fairly straightforward.*
...
- *Bounce [Back](REL_PATH_PREFIXRules/Abilities/Fury/1st-Level%20Features/BackREL_PATH_SUFFIX) Fast:* Whenever you rest for 8 hours or more, you can gain the benefit of a respite. Once you use this benefit, you can't use it again until you have taken a regular respite.
- *Reserves of Strength:* Your recovery value is half your Stamina
- *Undying:* You can't be affected by the [bleeding](REL_PATH_PREFIXRules/Conditions/BleedingREL_PATH_SUFFIX) condition.
...
- *Bye-Bye:* You can use a maneuver to [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) yourself and each willing ally within 5 squares of you to new positions within 10 squares of your original starting point. Once you use this benefit, you can't use it again until you earn 1 or more Victories.
...
- *Slippery:* You can't be [grabbed](REL_PATH_PREFIXRules/Conditions/GrabbedREL_PATH_SUFFIX) against your will.
...
At the start of character creation, your Renown is 0. Some careers can increase your initial Renown score (see [Chapter 4: Background](REL_PATH_PREFIXRules/Chapters/BackgroundREL_PATH_SUFFIX)).
...
Each hero starts with a Wealth score of 1 that can be improved by their choice of career during character creation (see [Chapter 4: Background](REL_PATH_PREFIXRules/Chapters/BackgroundREL_PATH_SUFFIX)). Your hero earns Wealth whenever you find and keep a massive amount of monetary treasure, such as a hoard of coins and gems from a dragon's lair, or several unique and valuable paintings gifted by a monarch as a reward for a job well done.
